...
class StaffTest {
  ...
  void creates() {
    Staff staff = Staff.create(
        9, 1, new StaffCommand(StaffSection.SW,"SW 운영진","홍길동","컴퓨터공학과 21","프론트엔드를 담당하고 있습니다.",null,null,3L,701L));
  ...
  void createsWithoutUserOrFile() {
    Staff staff = Staff.create(9, 1, new StaffCommand(StaffSection.EXECUTIVE,"회장","김철수","경영학과 20",null,null,null,null,null));
  ...
  void updatesWithoutChangingOrder() {
    Staff staff = Staff.create(9, 1, new StaffCommand(StaffSection.SW,"SW 운영진","홍길동","컴퓨터공학과 21",null,null,null,null,null));

    staff.update(new StaffCommand(StaffSection.SW, "부회장", "이영희", "전자공학과 19",
        "안녕하세요", "https://github.com/hong", "https://instagram.com/hong", 5L, 702L));
